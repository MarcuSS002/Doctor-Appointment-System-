  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-gray-400'>
      ...
      <ul className='md:flex items-start gap-2 font-medium sm:hidden'>
        <NavLink to='/'>
          <li className='py-2 px-3 rounded-xl hover:bg-blue-50'>Home</li>
          <hr className='border-none outline-none h-0.5 w-3/4 bg-primary m-auto hidden' />
        </NavLink>
        <NavLink to='/doctors'>
          <li className='py-2 px-3 rounded-xl hover:bg-blue-50'>Doctors</li>
          <hr className='border-none outline-none h-0.5 w-3/4 bg-primary m-auto hidden' />
        </NavLink>
        <NavLink to='/about'>
          <li className='py-2 px-3 rounded-xl hover:bg-blue-50'>About</li>
          <hr className='border-none outline-none h-0.5 w-3/4 bg-primary m-auto hidden' />
        </NavLink>
        <NavLink to='/contact'>
          <li className='py-2 px-3 rounded-xl hover:bg-blue-50'>Contact</li>
          <hr className='border-none outline-none h-0.5 w-3/4 bg-primary m-auto hidden' />
        </NavLink>
      </ul>
